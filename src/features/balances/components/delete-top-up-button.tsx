...
/**
 * DeleteTopUpButton — inline delete with a two-step confirmation.
 */
...
import { deleteTopUp } from "@/features/balances/actions";

type Step = "idle" | "confirm" | "deleting";

interface DeleteTopUpButtonProps {
  id: string;
}

export function DeleteTopUpButton({ id }: DeleteTopUpButtonProps) {
  ...
  return (
    <span className="flex flex-col items-end gap-1">
      <span className="max-w-[200px] text-right text-xs font-medium text-slate-300">
        Delete this top-up?
      </span>
