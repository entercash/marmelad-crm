        ...
        >
          {result.success ? (
            <>
              ...
              {result.accounts} account{result.accounts !== 1 ? "s" : ""}, {result.totalCampaigns} campaigns, {result.statsRows} stats, {result.publisherStatsRows} publisher, {result.itemStatsRows} item rows
            </>
          ) : (
            <>
